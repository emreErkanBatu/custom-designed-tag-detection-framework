...
# -*- coding: utf-8 -*-
"""Tag layout utilities for non-overlapping synthetic sample placement."""

import random
import os

# Number of tags to place
MIN_TAGS = 20
MAX_TAGS = 30
...
COLLISION_PADDING = 2               # Extra gap between boxes
EFFECTIVE_SIZE_FACTOR = 0.85        # Slightly shrink boxes for collision checking
...
def generate_random_layout(scene_shape,
    ...
    Parameters:
        ...
        min_tags/max_tags : Target tag-count range.
